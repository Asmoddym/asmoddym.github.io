  ...
  public ImageDataDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfImage = new EntityInsertionAdapter<Image>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `images`(`id`,`project_id`,`file_name`,`image_name`,`uri`,`creation_time`,`last_modification_time`,`color`) VALUES (?,?,?,?,?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, Image value) {
        ...
        stmt.bindLong(6, value.getCreation_time());
        stmt.bindLong(7, value.getLast_modification_time());
    ...
    return new ComputableLiveData<List<Image>>() {
      ...
      protected List<Image> compute() {
        ...
        try {
          ...
          final int _cursorIndexOfCreationTime = _cursor.getColumnIndexOrThrow("creation_time");
          final int _cursorIndexOfLastModificationTime = _cursor.getColumnIndexOrThrow("last_modification_time");
          ...
          while(_cursor.moveToNext()) {
            ...
            final long _tmpCreation_time;
            _tmpCreation_time = _cursor.getLong(_cursorIndexOfCreationTime);
            _item.setCreation_time(_tmpCreation_time);
            final long _tmpLast_modification_time;
            _tmpLast_modification_time = _cursor.getLong(_cursorIndexOfLastModificationTime);
            _item.setLast_modification_time(_tmpLast_modification_time);
            final int _tmpColor;
      ...
      protected Image compute() {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            final long _tmpCreation_time;
            _tmpCreation_time = _cursor.getLong(_cursorIndexOfCreationTime);
            _result.setCreation_time(_tmpCreation_time);
            final long _tmpLast_modification_time;
            _tmpLast_modification_time = _cursor.getLong(_cursorIndexOfLastModificationTime);
            _result.setLast_modification_time(_tmpLast_modification_time);
            final int _tmpColor;
            _tmpColor = _cursor.getInt(_cursorIndexOfColor);
