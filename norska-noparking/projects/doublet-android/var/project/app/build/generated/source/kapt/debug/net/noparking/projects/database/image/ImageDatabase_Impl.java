  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(7) {
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `images` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `project_id` INTEGER NOT NULL, `file_name` TEXT NOT NULL, `image_name` TEXT NOT NULL, `uri` TEXT NOT NULL, `creation_time` INTEGER NOT NULL, `last_modification_time` INTEGER NOT NULL, `color` INTEGER NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"e063e5c4fa4fec2c1c823a2fbaf3d874\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        _columnsImages.put("creation_time", new TableInfo.Column("creation_time", "INTEGER", true, 0));
        _columnsImages.put("last_modification_time", new TableInfo.Column("last_modification_time", "INTEGER", true, 0));
    ...
    }, "e063e5c4fa4fec2c1c823a2fbaf3d874");
