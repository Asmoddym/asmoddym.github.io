  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(5) {
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `lines` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `polygon_id` INTEGER NOT NULL, `image_id` INTEGER NOT NULL, `from_x` REAL NOT NULL, `from_y` REAL NOT NULL, `to_x` REAL NOT NULL, `to_y` REAL NOT NULL, `color` INTEGER NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"fdaf7eb632a451d37baec831fa6c5ab3\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsLines = new HashMap<String, TableInfo.Column>(8);
        ...
        _columnsLines.put("image_id", new TableInfo.Column("image_id", "INTEGER", true, 0));
    ...
    }, "fdaf7eb632a451d37baec831fa6c5ab3");
