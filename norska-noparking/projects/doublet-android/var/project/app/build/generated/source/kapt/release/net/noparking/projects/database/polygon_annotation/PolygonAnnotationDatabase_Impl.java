  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(6) {
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `polygon_annotations` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `polygon_id` INTEGER NOT NULL, `image_id` INTEGER NOT NULL, `width` REAL NOT NULL, `height` REAL NOT NULL, `surface` REAL NOT NULL, `comment` TEXT NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"f39690949a8b74357736f82c2fdacbca\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        _columnsPolygonAnnotations.put("width", new TableInfo.Column("width", "REAL", true, 0));
        _columnsPolygonAnnotations.put("height", new TableInfo.Column("height", "REAL", true, 0));
    ...
    }, "f39690949a8b74357736f82c2fdacbca");
