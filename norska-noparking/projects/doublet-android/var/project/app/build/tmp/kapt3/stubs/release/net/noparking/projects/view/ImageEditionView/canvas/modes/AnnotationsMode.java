...
public final class AnnotationsMode {
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<net.noparking.projects.view.ImageEditionView.canvas.modes.utl.polygon.Polygon> getPolygons$app_release() {
        return null;
    }
