...
class Norska_Ladditionestpourmoi_Hooks extends Norska_Opentime_Hooks {
	function install_after () {
		...
		$this->configure_plugin($this->parameters['path'] . "applications/repas/");
	}
	...
	function send_subject_after($subject) {
		return "[nopkg ladditionestpourmoi.fr ".$this->svn->number_revision()."] ".$subject;
	}
